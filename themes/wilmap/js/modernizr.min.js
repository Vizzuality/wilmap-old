...
!function (e, t, n) {
  function i(e) {
    var t = w.className,
        n = Modernizr._config.classPrefix || "";if (k && (t = t.baseVal), Modernizr._config.enableJSClass) {
    ...
    var e, t, n, i, o, a, s;for (var d in x) {
    ...
    var e = t.body;return e || (e = a(k ? "svg" : "body"), e.fake = !0), e;
  }function c(e, n, i, r) {
    var o,
        s,
        d,
    ...
    function s() {
      ...
      if (m = e[f], b = $.style[m], l(m, "-") && (m = d(m)), $.style[m] !== n) {
        if (o || r(i, "undefined")) return s(), "pfx" == t ? m : !0;try {
          $.style[m] = i;
        } catch (v) {}if ($.style[m] != b) return s(), "pfx" == t ? m : !0;
      }
    }return s(), !1;
    ...
    return g(e, n, n, t, i);
      ...
      x = [],
      T = { _version: "3.0.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(e, t) {
  ...
  }), Modernizr.addTest("ie8compat", !e.addEventListener && !!t.documentMode && 7 === t.documentMode), Modernizr.addTest("serviceworker", "serviceWorker" in navigator), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), Modernizr.addTest("websockets", "WebSocket" in e && 2 === e.WebSocket.CLOSING);var w = t.documentElement,
      k = "svg" === w.nodeName.toLowerCase();Modernizr.addTest("canvas", function () {
    ...
    function n(t, n) {
      var r;return t ? (n && "string" != typeof n || (n = a(n || "div")), t = "on" + t, r = t in n, !r && i && (n.setAttribute || (n = a("div")), n.setAttribute(t, ""), r = "function" == typeof n[t], n[t] !== e && (n[t] = e), n.removeAttribute(t)), r) : !1;
    }var i = !("onblur" in t.documentElement);return n;
  }();T.hasEvent = E, Modernizr.addTest("ambientlight", E("devicelight", e)), Modernizr.addTest("inputsearchevent", E("search"));var z = T._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];T._prefixes = z, Modernizr.addTest("csscalc", function () {
    var e = "width:",
        t = "calc(10px);",
        n = a("a");return n.style.cssText = e + z.join(t + e), !!n.style.length;
  }), Modernizr.addTest("cssgradients", function () {
    var e = "background-image:",
        t = "gradient(linear,left top,right bottom,from(#9f9),to(white));",
        n = "linear-gradient(left top,#9f9, white);",
        i = e + z.join(n + e).slice(0, -e.length);Modernizr._config.usePrefixes && (i += e + "-webkit-" + t);var r = a("a"),
        o = r.style;return o.cssText = i, ("" + o.backgroundImage).indexOf("gradient") > -1;
  }), Modernizr.addTest("opacity", function () {
    var e = a("a").style;return e.cssText = z.join("opacity:.55;"), /^0.55$/.test(e.opacity);
  });var P = "CSS" in e && "supports" in e.CSS,
      j = "supportsCSS" in e;Modernizr.addTest("supports", P || j);var L;!function () {
    var e = {}.hasOwnProperty;L = r(e, "undefined") || r(e.call, "undefined") ? function (e, t) {
    ...
    T.addTest = s;
  }), Modernizr.addTest("svgasimg", t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"));var R = "Moz O ms Webkit",
      q = T._config.usePrefixes ? R.split(" ") : [];T._cssomPrefixes = q;var A = function A(t) {
    var i,
        r = z.length,
        o = e.CSSRule;if ("undefined" == typeof o) return n;if (!t) return !1;if (t = t.replace(/^@/, ""), i = t.replace(/-/g, "_").toUpperCase() + "_RULE", i in o) return "@" + t;for (var a = 0; r > a; a++) {
      var s = z[a],
          d = s.toUpperCase() + "_" + i;if (d in o) return "@-" + s.toLowerCase() + "-" + t;
    }return !1;
  };T.atRule = A;var M = T._config.usePrefixes ? R.toLowerCase().split(" ") : [];T._domPrefixes = M;var B = T.testStyles = c;Modernizr.addTest("touchevents", function () {
    var n;if ("ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch) n = !0;else {
      var i = ["@media (", z.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");B(i, function (e) {
        n = 9 === e.offsetTop;
      });
    }return n;
    ...
    var i = t.getElementById("smodernizr"),
        ...
        a = /src/i.test(o) && 0 === o.indexOf(n.split(" ")[0]);Modernizr.addTest("fontface", a);
  ...
  }();T.mq = H, Modernizr.addTest("mediaqueries", H("only all"));var W = { elem: a("modernizr") };Modernizr._q.push(function () {
    delete W.elem;
  });var $ = { style: W.elem.style };Modernizr._q.unshift(function () {
    delete $.style;
      ...
      function r() {
        ...
        try {
          var i,
              ...
              s = "lebowski",
              d = !1,
              l = t.body.firstElementChild || t.body.firstChild;if (o.innerHTML = s + n + s, t.body.insertBefore(o, l), t.body.insertBefore(r, o), r.setSelectionRange ? (r.focus(), r.setSelectionRange(0, 0)) : r.createTextRange && (i = r.createTextRange(), i.collapse(!0), i.moveEnd("character", 0), i.moveStart("character", 0), i.select()), e.find) d = e.find(s + s);else try {
        ...
        if (!v("hyphens", "auto", !0)) return !1;try {
          return r();
        } catch (e) {
          return !1;
        }
    ...
    var e = !!v("perspective", "1px", !0),
      ...
      var n;Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{left:9px;position:absolute;height:5px;margin:0;padding:0;border:0}}", B(n, function (t) {
        e = 9 === t.offsetLeft && 5 === t.offsetHeight;
      });
    }return e;
  }), Modernizr.addTest("preserve3d", v("transformStyle", "preserve-3d")), Modernizr.addTest("csstransitions", v("transition", "all", !0));var U = T.prefixed = function (e, t, n) {
    return 0 === e.indexOf("@") ? A(e) : (-1 != e.indexOf("-") && (e = d(e)), t ? g(e, t, n) : g(e, "pfx"));
  };Modernizr.addTest("objectfit", !!U("objectFit"), { aliases: ["object-fit"] }), o(), i(y), delete T.addTest, delete T.addAsyncTest;for (var V = 0; V < Modernizr._q.length; V++) {
    Modernizr._q[V]();
